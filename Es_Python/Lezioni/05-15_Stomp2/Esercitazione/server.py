...
if __name__ == "__main__":
    ...
    serviceImpl = ServiceImpl(int(PORT), q) #è skeleton per ereditarietà
    serviceImpl.run_skeleton()
    
    
    #sviluppa prima client e parte del dispatcher che lavora con client (testandola) !!
    #non andare avanti sul server rischiando che poi non funzioni nulla
    #mi chiederà max 2 middleware da implementare per prova