...
class ServiceProxy(Service):
    ...
    def __init__(self, port): #parametri per la comunicazione su socket
        self.port = port
        self.ip = 'localhost'
...
class MyListener(stomp.ConnectionListener):
    ...
    def on_message(self, frame):
        ...
        p = SkeletonProcess(conn, proxy, frame.body) # callable object proc_fun  | Spawno un nuovo processo
        p.start()
