...
p1.join()
    ...
    #lo stesso codice può avere (usando multiprocessing) comportamenti diversi su linux o python


    #la fork non è una syscall safe sui lock -> se acquisisco lock e poi genero thread figli, lo stato verrà ricopiato e può
    #essere causa di problemi alla safety nel contesto delle risorse