...
@javax.annotation.Generated(
    ...
    comments = "Source: salutoni.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class GreeterGrpc {

  private GreeterGrpc() {}

  public static final java.lang.String SERVICE_NAME = "ciaoooo.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ciaoooo.Salutoni.stringMessage,
      ciaoooo.Salutoni.stringMessage> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = ciaoooo.Salutoni.stringMessage.class,
      responseType = ciaoooo.Salutoni.stringMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ciaoooo.Salutoni.stringMessage,
      ciaoooo.Salutoni.stringMessage> getSayHelloMethod() {
    io.grpc.MethodDescriptor<ciaoooo.Salutoni.stringMessage, ciaoooo.Salutoni.stringMessage> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<ciaoooo.Salutoni.stringMessage, ciaoooo.Salutoni.stringMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ciaoooo.Salutoni.stringMessage.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(ciaoooo.Salutoni.stringMessage request,
        io.grpc.stub.StreamObserver<ciaoooo.Salutoni.stringMessage> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(ciaoooo.Salutoni.stringMessage request,
        io.grpc.stub.StreamObserver<ciaoooo.Salutoni.stringMessage> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public ciaoooo.Salutoni.stringMessage sayHello(ciaoooo.Salutoni.stringMessage request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ciaoooo.Salutoni.stringMessage> sayHello(
        ciaoooo.Salutoni.stringMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((ciaoooo.Salutoni.stringMessage) request,
              (io.grpc.stub.StreamObserver<ciaoooo.Salutoni.stringMessage>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ciaoooo.Salutoni.stringMessage,
              ciaoooo.Salutoni.stringMessage>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ciaoooo.Salutoni.getDescriptor();
    }
