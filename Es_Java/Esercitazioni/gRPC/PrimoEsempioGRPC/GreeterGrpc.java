...
public final class GreeterGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "PrimoEsempioGRPC.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<PrimoEsempioGRPC.HelloRequest,
      PrimoEsempioGRPC.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = PrimoEsempioGRPC.HelloRequest.class,
      responseType = PrimoEsempioGRPC.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<PrimoEsempioGRPC.HelloRequest,
      PrimoEsempioGRPC.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<PrimoEsempioGRPC.HelloRequest, PrimoEsempioGRPC.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<PrimoEsempioGRPC.HelloRequest, PrimoEsempioGRPC.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  PrimoEsempioGRPC.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  PrimoEsempioGRPC.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void sayHello(PrimoEsempioGRPC.HelloRequest request,
        io.grpc.stub.StreamObserver<PrimoEsempioGRPC.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
    ...
    /**
     */
    public void sayHello(PrimoEsempioGRPC.HelloRequest request,
        io.grpc.stub.StreamObserver<PrimoEsempioGRPC.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingV2Stub
    ...
    /**
     */
    public PrimoEsempioGRPC.HelloReply sayHello(PrimoEsempioGRPC.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<PrimoEsempioGRPC.HelloReply> sayHello(
        PrimoEsempioGRPC.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((PrimoEsempioGRPC.HelloRequest) request,
              (io.grpc.stub.StreamObserver<PrimoEsempioGRPC.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              PrimoEsempioGRPC.HelloRequest,
              PrimoEsempioGRPC.HelloReply>(
  ...
  private static abstract class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return PrimoEsempioGRPC.Helloworld.getDescriptor();
    }
